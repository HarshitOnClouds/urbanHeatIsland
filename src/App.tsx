          ...
          <div className="max-w-6xl w-full mx-auto">
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center mb-6 sm:mb-8 lg:mb-12">
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                {/* Stats */}
                <div className="flex flex-col xs:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 lg:gap-6 pt-2 sm:pt-4">
                  <div className="text-center lg:text-left">
                    <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">2019-2024</div>
                    <div className="text-xs sm:text-sm text-slate-400">Data Coverage</div>
                  </div>
                  <div className="hidden xs:block w-px h-6 sm:h-8 lg:h-12 bg-white/20"></div>
                  <div className="text-center lg:text-left">
                    <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400">Sentinel-2</div>
                    <div className="text-xs sm:text-sm text-slate-400">Satellite Source</div>
                  </div>
                  <div className="hidden xs:block w-px h-6 sm:h-8 lg:h-12 bg-white/20"></div>
                  <div className="text-center lg:text-left">
                    <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-400">30m</div>
                ...
                <div className="relative w-56 h-56 sm:w-64 sm:h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative w-full h-full">
                      ...
                      <div className="absolute inset-8 sm:inset-10 lg:inset-12 rounded-full bg-gradient-to-br from-orange-500/40 via-red-500/40 to-pink-500/40 backdrop-blur-xl flex items-center justify-center shadow-2xl">
                        <div className="text-center space-y-1 sm:space-y-2">
                          <Thermometer className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 mx-auto text-white" />
                          <div className="text-xl sm:text-2xl lg:text-4xl font-bold">UHI</div>
                  ...
                  {/* Floating icons */}
                  <div className="absolute top-3 sm:top-4 lg:top-8 right-3 sm:right-4 lg:right-8 p-2 sm:p-2 lg:p-3 bg-blue-500/20 backdrop-blur-sm border border-blue-500/30 rounded-xl animate-bounce" style={{animationDuration: '3s'}}>
                    <Satellite className="w-3 h-3 sm:w-4 sm:h-4 lg:w-6 lg:h-6 text-blue-300" />
                  </div>
                  <div className="absolute bottom-6 sm:bottom-8 lg:bottom-12 left-3 sm:left-4 lg:left-8 p-2 sm:p-2 lg:p-3 bg-green-500/20 backdrop-blur-sm border border-green-500/30 rounded-xl animate-bounce" style={{animationDuration: '3s', animationDelay: '1s'}}>
                    <Leaf className="w-3 h-3 sm:w-4 sm:h-4 lg:w-6 lg:h-6 text-green-300" />
                  </div>
                  <div className="absolute top-1/3 left-1 sm:left-2 lg:left-4 p-2 sm:p-2 lg:p-3 bg-orange-500/20 backdrop-blur-sm border border-orange-500/30 rounded-xl animate-bounce" style={{animationDuration: '3s', animationDelay: '2s'}}>
                    <Sun className="w-3 h-3 sm:w-4 sm:h-4 lg:w-6 lg:h-6 text-orange-300" />
                  </div>
                </div>
              </div>
            </div>
